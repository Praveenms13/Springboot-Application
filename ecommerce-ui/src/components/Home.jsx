...
export default function Home() {
    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Failed to connect to data source. please try again later."
      );
    } finally {
      setLoading(false);
    }
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800" style={{ height: 'calc(100vh - 140px)' }}>
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center bg-gradient-to-br from-red-50 to-pink-100 dark:from-gray-900 dark:to-red-900 p-6 relative" style={{ height: 'calc(100vh - 140px)' }}>
        {/* Error Icon */}
